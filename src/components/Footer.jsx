...
export default function Footer() {
  ...
  <div tabIndex={0} role="button" >credits images</div>
  <ul tabIndex="-1" className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
    <li><a href="https://www.freepik.com/free-photo/hiking-shoes-action-mountain-desert-trail-path_4351633.htm#fromView=search&page=1&position=6&uuid=1a3aaa9c-de50-4795-9e73-9d4cf3f296fa&query=un+pas">Image by jcomp on Freepik</a></li>
    <li>
