...
export default function CardPortefolio({image,lien,texte,titre}) {
  return (
       <div className="card min-h-80  w-[85%] md:w-[30%] mb-5 md:mb-0  shadow-sm relative ">
                                   ...
                                   <div className=" bg-black/45 rounded-xl text-white min-h-80 h-full w-full flex flex-col items-center gap-2 text-center justify-end ">
